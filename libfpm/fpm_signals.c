...
static void sig_soft_quit(int signo)
{
	...
	zlog(ZLOG_STUFF, ZLOG_NOTICE, "child process %u is receiving %s signal ", getpid(), fpm_signal_names[SIGQUIT] );
...
static void sig_handler(int signo)
{
	...
	zlog(ZLOG_STUFF, ZLOG_NOTICE, "master process %u is receiving signal %c", getpid(), sig_chars[signo] );
...
int fpm_signals_init_main()
{
	...
	zlog(ZLOG_STUFF, ZLOG_NOTICE, "master process %d signals OK", getpid() );
